...
and close-neighbor requests that should not activate `product`.

Use `/product` as documentation shorthand only. Codex explicit invocation is
`$product`; other clients vary.
